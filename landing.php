            ...
            <div class="foot">
                <div class="section">
                    <div class="col_cus span_1_of_4_cus">
                        <img style="background-image:url('(<?php bloginfo('template_url'); ?>/img/mpic1.jpg');" class="footImg" /><br>
                        <p class="blogsubtext">
                             <span class="introtext2">בין השירים הישראלים הבודדים</span><br>
                            שאני ישראלי שאתה אוהב?</p>
                    </div>
                    <div class="col_cus span_1_of_4_cus">
